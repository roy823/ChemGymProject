...
& $python "ProjectMain\week7\week7_pareto_report.py" --save-root $saveRoot --baselines-glob-root $baselinesRoot
& $python "ProjectMain\week7\week7_significance_analysis.py" --save-root $saveRoot --baselines-glob-root $baselinesRoot

Write-Host "[Week7-CloseLoop] Refresh complete. Open $saveRoot\REPORT.md."
Write-Host "[Week7-CloseLoop] Manual interpretation lives in ProjectMain\week7\week7_key_findings_2026_04_25.md (or whichever date stamp applies)."
